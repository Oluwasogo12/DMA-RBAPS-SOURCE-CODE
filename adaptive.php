...
$topicTableMap = [
    ...
    'civic'               => ['mapping_civic',        'new'], // Legacy fallback for lowercase version
    ...
    'Technical Drawing'   => null, // No mapping available
];

// Normalize subject name for consistent mapping
$normalizedSubject = $subject;
if (strtolower($subject) === 'civic') {
    $normalizedSubject = 'Civic Education';
}
$subjectForMapping = $topicTableMap[$normalizedSubject] ?? $topicTableMap[$subject] ?? false;

$topicTableEntry = $subjectForMapping; // Use the normalized lookup
$topicTable      = null;
